    ...
    <section>
        <div class=" container main d-flex flex-row justify-content-between flex-md-row flex-lg-row mb-5  mt-5 ">
            <div class="first-section container animate__animated  animate__backInLeft" style="margin-top: 80px;">
                ...
                <h3 class="display-3 " style="line-height: 1;">cours supplémentaires !!</h3>
                <p class="text-black " style="font-size: 100%;
                font-weight: 400px;">En ligne ou en face-à-face,
                    faites votre choix parmi 19 millions de professeurs</p>
                <a class="buttons" href="Apropos">
                    <button type="button " class="btn button-index-r btn-round">lire la suite</button>
    ...
    <section class="section-cards cards container bg-light rounded mt-5 shadow p-3 mb-5 bg-body rounded mb-5">
        ...
        <div class=" container  d-flex flex-row  justify-content-around  mb-5  ">
            <div class="first-card text-center p-3 mb-3 mt-3  rounded ">
                ...
                <div class="buticone">
                    <button class="btn btn-1 btn-dark  ml-2" style="font-size: 9px; color: #f2e30b;" type="button">FAITES LA RECHRCHE
                    </button>
                </div>
            ...
            <div class="first-card text-center  p-3 mb-3 mt-2  rounded">
                ...
                <p class="text-muted mb-0 mt-2 mb-2 px-1" style=" font-size: 11px; ">Rapides comme l’éclair, les enseignants vous répondent en quelques heures ! Et si vous ne trouvez pas tout de suite le professeur idéal, notre équipe sera là pour vous aider.</p>
                <div class="buticone">
                    <button class="btn btn-1 btn-dark  ml-1" style="font-size: 9px; color: #f2e30b;" type="button">contactez maintenant
                    </button>
                </div>
            </div>
            <div class="first-card text-center  p-3 mb-3 mt-4  rounded">
                ...
                <div class="buticone">
                    <button class="btn btn-1 btn-dark ml-1" style="font-size: 9px; color: #f2e30b ;" type="button">PLUS D'INFO
                    </button>
                </div>
            </div>
        </div>
