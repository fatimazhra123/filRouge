            ...
            <div class="row g-2">
                ...
                <div class="col-md-4">
                    ...
                    <div class="p-3 text-center border-end">
                        ...
                        <img class="rounded-circle" width="120" src="https://i.imgur.com/rvQ3LAt.jpg" />
                        <h4 class="mt-2">Fatimazahra bouamoud</h4>
                        <span class="d-flex justify-content-center align-items-center"><small class="margin-right"></small><i class="ml-1 fa fa-info-circle text-success"></i></span>
                        <span class="address-content">directeur d'école</span>
                        <div class="content-aboutme mt-3 p-3">

                            <h4>Qui sommes nous ??</h4>
                            <span>les cours supplémentaires est le site de référence du partage de connaissances dont le but est la mise en relation entre professeurs, coachs, professionnels et élèves. facilite l’apprentissage, le partage de passions et de connaissances. </span>
                ...
                <div class=" réserve col-md-8">
                    ...
                    <div class="p-3">
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            <h4><span class="fw-bold ">Trouvez votre professeur</span></h4>
                        </div>

                        <div class="d-flex gap-2 mt-2">

                            <div>
                                <img class="rounded-circle" width="120" height="90" src="Views/Assets/image/R.jpg">
                            </div>

                            <div>
                                <img class="rounded-circle" width="120" height="90" src="Views/Assets/image/prof2.jpg">
                            </div>

                            <div>
                                <img class="rounded-circle" width="120" height="90" src="Views/Assets/image/mohammed.jpg">
                            </div>

                            <div>
                                <img class="rounded-circle" width="120" height="90" src="Views/Assets/image/prof.jpg">
                            </div>

                            <div>
                                <img class="rounded-circle" width="120" height="90" src="Views/Assets/image/download.jpg">
                            </div>
                        ...
                        <div class="d-flex gap-2 mt-2">
                            ...
                            <div>
                                <img class="rounded img-fluid" width="100" src="">
                            </div>

                            <div>
                                <img class="rounded-circle" width="120" height="90" src="Views/Assets/image/MARI.jpg">
                            </div>

                            <div>
                                <img class="rounded-circle" width="120" height="90" src="Views/Assets/image/OIP11.jpg">
                            </div>

                            <div>
                                <img class="rounded-circle" width="120" height="90" src="Views/Assets/image/OIP33.jpg">
                            </div>

                            <div>
                                <img class="rounded-circle" width="120" height="90" src="Views/Assets/image/prof11.jpg">
                            </div>

                            <div>
                                <img class="rounded-circle" width="120" height="90" src="Views/Assets/image/OIP.jpg">
                            </div>
                        ...
                        <div class="portfolio-content mt-6">

                            <p class="fw-bold text">
                                Passionnés, Rêveurs, Utopistes, Partageurs, Sérieux, Engagés, Polyglottes et toujours partants pour l'aventure. cette plateforme, c'est plus de 200 collaborateurs pour vous aider à transmettre vos passions et 24H/24. </p>
                        ...
                        <div class="mt-2">
                            <h5>Matière des cours supplémentaires</h5>

                            <div class="Réserve">
                                <span class="badge  mb-1">Cours de mathématiques</span>
                                <span class="badge  mb-1">Informatique</span>

                                <span class=" badge mb-1">Les langue</span>

                                <span class=" badge mb-1">sciences humaines</span>
                                <span class="badge mb-1"> dessins</span>

                                <span class="badge  mb-1">musique</span>
                                <span class="badge  mb-1">biologie</span>
                                <span class="badge  mb-1">chimie</span>

                                <span class="badge  mb-1">physique appliquée</span>

                                <span class="badge  mb-1">philosophie</span>
                                <span class="badge  mb-1">psychologie</span>

                                <span class="badge  mb-1"> économie</span>
