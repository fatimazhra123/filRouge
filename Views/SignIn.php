...
<body class="login-index">
  <div class="  login-index container-fluid "  style="height:100vh; width:100vw; position:absolute;; top:50%; left:50%; transform:translate(-50%,-50%); display:flex; justify-content:center; align-items:center ;">
    <div class="col-12 col-lg-10 d-flex justify-content-center align-items-center" style="min-height:660px;width:65%">
      <div class="border border-dark bg-white formulaire col-12 col-sm-8 col-md-6 d-flex flex-column align-items-center px-5" style="height:550px;">
        <h5 class="bienvenu text-muted mt-3">Bienvenu Sur</h5>
        <h3 class=" text-dark mt-3">Sign-IN</h3>
        ...
        <form class="px-3 align-self-start w-100" method="post" style="height:400px;">
          ...
          <div class="mb-4 pass position-relative">
            ...
            <input type="password" class="form-control text-muted shadow-none ps-5" placeholder="Mot de passe" id="Password" name="Password" style="border:0;border-bottom: 3px solid #f2e30b; border-radius:0;">
         ...
         <input type="submit" class="btn-log w-100 mb-3 text-dark" id="Login" name="submit" value="Login">
                                ...
                                <a class="text-info text-decoration-underline" href="signup"> <span>Sign-up </span></a>ici
                            </div>
        </form>
      </div>
      <div class="border border-dark d-none position-relative d-md-flex col-md-6" style="height:550px;background: #EEEEEE;">
      
        <!-- <div class="h-100 w-100" style=""> -->
        <img src="Views/Assets/image/Kids reading-amico.png" alt="" class="w-100 h-100">
        <!-- </div> -->
        <div class="d-flex flex-column align-items-center h-100 w-100 text-muted" style="position:absolute; z-index:1; left:0; top:0;">
